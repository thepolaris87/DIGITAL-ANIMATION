...
export default function Attribute() {
    ...
    const [attribute, setAttribute] = useState<{ rx: number; ry: number }>();
    ...
    useEffect(() => {
        ...
        const { rx = 0, ry = 0 } = currentTarget.object;
        setAttribute({ rx: Number(parseFloat(rx).toFixed(2)), ry: Number(parseFloat(ry).toFixed(2)) });
    }, [currentTarget]);
